...
var myState;
jumpStr=10;		   //default to 10
maxProj=3;		   //default to 3
playerSpeed=5;     //less than 20 for no bugs. default to 5
deathfloattime=40; //time the player can hang in the air at their starting spot before falling
maxhp=5;
maxlives=5;
...
CanvasState.prototype.draw = function() {
	...
	for(var i=0; i<players.length; i++) {
		...
		else if(players[i].floatticks<deathfloattime*.75) players[i].mobile=true;
		else if(players[i].floatticks>0) players[i].floatticks--;
	}
